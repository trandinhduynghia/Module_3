    ...
    <div style="padding-left: 12%">
        <form method="post" class="modal-content" name="capnhat">
            <div class="container">
                ...
                <input type="text" placeholder="Giá tiền" name="giatien" required >

                <label ><b>Số lượng</b></label>
                <input type="text" placeholder="Số lượng" name="soluong" required >

                <label ><b>Mô tả</b></label>
                <input type="text" placeholder="Mô tả" name="mota" required >

                <label ><b>Thẻ sim</b></label>
                <input type="text" placeholder="Thẻ sim" name="thesim" required >

                <label ><b>Bộ nhớ</b></label>
                <input type="text" placeholder="Bộ nhớ" name="bonho" required >

                <label ><b>Ram</b></label>
                <input type="text" placeholder="Ram" name="ram" required >

                <label ><b>Ảnh bìa</b></label>
                <input type="text" placeholder="Ảnh bìa" name="anhbia" required >

                <label ><b>Loại sản phẩm</b></label>
                <input type="text" placeholder="Loại sản phẩm" name="madanhmuc" required >
