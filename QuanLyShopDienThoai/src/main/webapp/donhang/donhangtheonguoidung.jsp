                    ...
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <c:forEach var="o" items="${donHangs}">
                                ...
                                <c:forEach var="u" items="${nguoiDungs}">
                                    <c:if test="${o.getManguoidung() == u.getManguoidung()}">
                                        <td class="shoping__cart__item" style="text-align: center">
                                                ${u.getHoten()}
                                        </td>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        <form method="get">
                                            <button class="btn btn-danger btn-sm" type="submit" style="background-color: #005cbf">
                                                <a style="text-decoration: none; color: white" href="/DonChiTiet?action=chitiet&madon=${o.getMadon()}">Chi tiết </a>
                                            </button>
                                        </form>
                                    </td>
