    ...
    <section class="checkout spad">
        <div class="container">
            ...
            <div class="checkout__form">
                <h4>Thêm sản phẩm</h4>
                <form action="/DanhSachSanPham?action=create" method="post">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" name="giatien" value="${sanPham.getGiatien()}">
                            </div>

                            <div class="checkout__input">
                                <p>Số lượng<span>*</span></p>
                                <input type="text" name="soluong" value="${sanPham.getSoluong()}">
                            </div>
                            ...
                            <div class="checkout__input">
                                <p>Thẻ sim<span>*</span></p>
                                <input type="text" name="thesim" value="${sanPham.getThesim()}">
                            </div>

                            <div class="checkout__input">
                                <p>Bộ nhớ<span>*</span></p>
                                <input type="text" name="bonho" value="${sanPham.getBonho()}">
                            </div>

                            <div class="checkout__input">
                                <p>Ram<span>*</span></p>
                                <input type="text" name="ram" value="${sanPham.getRam()}">
                            </div>

                            <div class="checkout__input">
                                <p>Ảnh bìa<span>*</span></p>
                                <input type="text" name="anhbia" value="${sanPham.getAnhbia()}">
                            </div>

                            <div class="checkout__input">
                                <p>Loại sản phẩm<span>*</span></p>
                                <input type="text" name="madanhmuc" value="${sanPham.getMadanhmuc()}">
                            </div>

                            <div class="checkout__input">
                                <input type="hidden" name="manguoidung" value="${sessionScope.nguoiDung.manguoidung}">
                            </div>
