            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">${sanPham.getGiatien()} VNĐ</div>
                        <ul>
                            <li><b>Số lượng</b> <span>${sanPham.getSoluong()}</span></li>
                            <li><b>Mô tả</b> <span>${sanPham.getMota()} </span></li>
                            <li><b>Thẻ sim</b> <span>${sanPham.getThesim()}</span></li>
                            <li><b>Bộ nhớ</b> <span>${sanPham.getBonho()}</span></li>
                            <li><b>Ram</b> <span>${sanPham.getRam()}</span></li>
