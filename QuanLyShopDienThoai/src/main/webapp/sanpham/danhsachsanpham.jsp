                        ...
                        <table>
                            ...
                            <c:forEach var="o" items="${listSanPham}">
                                <tr>
                                    ...
                                    <td class="shoping__cart__item" style="text-align: center">
                                        <img src="${o.getAnhbia()}" style="width: 150px; height: 150px">
                                    </td>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        <form method="get">
                                            <button class="btn btn-danger btn-sm" type="submit" style="background-color: #005cbf">
                                                <a style="text-decoration: none; color: white" href="/DanhSachSanPham?action=edit&masp=${o.getMasp()}">Sửa</a>
                                            </button>
                                        </form>
                                    </td>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        <form method="get">
                                            <button class="btn btn-danger btn-sm" type="submit">
                                                <a style="text-decoration: none; color: white" href="/DanhSachSanPham?action=delete&masp=${o.getMasp()}">Xóa</a>
                                            </button>
                                        </form>
                                    </td>
