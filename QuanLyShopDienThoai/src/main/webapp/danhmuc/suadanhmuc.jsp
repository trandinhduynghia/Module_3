    ...
    <section class="checkout spad">
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form action="/DanhMuc?action=edit" method="post">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">

                            <div class="checkout__input">
                                <p>Mã danh mục<span>*</span></p>
                                <input type="text" name="madanhmuc" value="${danhMuc.getMadanhmuc()}">
                            </div>

                            <div class="checkout__input">
                                <p>Tên danh mục<span>*</span></p>
                                <input type="text" name="tendanhmuc" value="${danhMuc.getTendanhmuc()}">
                            </div>
