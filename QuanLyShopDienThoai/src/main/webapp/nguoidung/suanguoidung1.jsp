    ...
    <section class="checkout spad">
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form action="/DanhSachNguoiDung?action=edit" method="post">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">

                            <div class="checkout__input">
                                <input type="hidden" name="manguoidung" value="${existingNguoiDung.getManguoidung()}">
                            </div>

                            <div class="checkout__input">
                                <p>Họ tên<span>*</span></p>
                                <input type="text" name="hoten" value="${existingNguoiDung.getHoten()}">
                            </div>

                            <div class="checkout__input">
                                <p>Email<span>*</span></p>
                                <input type="text" name="email" value="${existingNguoiDung.getEmail()}">
                            </div>

                            <div class="checkout__input">
                                <p>Điện thoại<span>*</span></p>
                                <input type="text" name="dienthoai" value="${existingNguoiDung.getDienthoai()}">
                            </div>

                            <div class="checkout__input">
                                <p>Mật khẩu<span>*</span></p>
                                <input type="text" name="matkhau" value="${existingNguoiDung.getMatkhau()}">
                            </div>

                            <div class="checkout__input">
                                <p>Nhập lại mật khẩu<span>*</span></p>
                                <input type="text" name="matkhaulai" value="${existingNguoiDung.getMatkhau()}">
                            </div>

                            <div class="checkout__input">
                                <p>Địa chỉ<span>*</span></p>
                                <input type="text" name="diachi" value="${existingNguoiDung.getDiachi()}">
                            </div>

                            <div class="checkout__input">
                                <p>Id quyền<span>*</span></p>
                                <input type="text" name="idquyen" value="${existingNguoiDung.getIDquyen()}">
                            </div>
                            <button type="button" class="site-btn" style="background-color: #f44336"><a href="/TrangChu" style="color: white; text-decoration: none">Hủy</a></button>
