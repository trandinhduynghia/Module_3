...
<form method="post" class="modal-content" >
    <div class="container">
        ...
        <input type="text" placeholder="Họ tên" name="manguoidung" required value="${existingNguoiDung.getManguoidung()}" >
        ...
        <div class="clearfix">
            <button type="button" class="cancelbtn"><a href="/DanhSachNguoiDung" style="color: white; text-decoration: none">Hủy</a></button>
