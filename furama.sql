...
-- 11
select k.MaDichVuDiKem, k.TenDichVuDiKem, DiaChi from dichvudikem k, loaikhach l join khachhang kh on l.MaLoaiKhach=kh.MaLoaiKhach
where TenLoaiKhach = 'Diamond' and (DiaChi like '%Vinh' or DiaChi like '%Quảng Trị')
